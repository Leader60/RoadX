...
const VALUES = [
  ...
  },
  {
    Icon: IconHeart,
    title: "تفاعل حيّ",
    text: "شارك إعجابك وتعليقاتك، تعليقاتكم موضع تقديرنا وتحظى بكامل اهتمامنا .",
  },
];
    ...
    <div className="rx-fade-in flex flex-col gap-5 px-4 py-6 pb-6">
      <div className="flex flex-col items-center gap-3 text-center">
        ...
        <p className="max-w-sm text-sm leading-relaxed text-muted-foreground text-pretty">
          منصة موسيقية وموقع عربي إعلامي/تجميعي يلعب دور الوسيط، نتابع وننشر أحدث الإصدارات الموسيقية العالمية،
          موجّهة لجمهور مميّز مهتم بالموسيقى عالية الجودة "جميع الحقوق محفوظة لأصحابها الأصليين"، هدفنا هو تسهيل اكتشاف الموسيقى الجديدة والرائجة في مكان واحد، مع احترام كامل لحقوق صانعي المحتوى.
        </p>
      </div>
